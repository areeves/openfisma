...
case 'Update':
	...
	if ($_POST['referrer'] == 'findingsource_update.php') {
	
		// create a new findingsource instance
		$findingsource = new FindingSource($_DB, $_E->decrypt($_POST['source_id']));
	
		// update the newly created findingsource with sanitized input	
...
$_TEMPLATE->assign('this_page',  'findingsource_update.php');
$_TEMPLATE->assign('this_title', 'FINDINGSOURCE > update');
...
$_TEMPLATE->display('findingsource_update.tpl');
