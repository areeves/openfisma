...
case 'Delete':
	...
	if ($_POST['referrer'] == 'network_delete.php') {
...
$_TEMPLATE->assign('this_page',  'network_delete.php');
$_TEMPLATE->assign('this_title', 'NETWORK > delete');
...
$_TEMPLATE->display('network_delete.tpl');
