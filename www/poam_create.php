...
case 'Create':
	...
	// create poam if we are referrer
	if ($_POST['referrer'] == 'poam_create.php') {
...
$_TEMPLATE->assign('this_page',  'poam_create.php');
$_TEMPLATE->assign('this_title', 'POAM > create');
...
define('PAGE_NAME',  'poam_create.php'); 
define('PAGE_TITLE', 'Poam: create');
...
$_TEMPLATE->display('poam_create.tpl');
