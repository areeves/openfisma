...
<form name="edit" method="post" action="/zfentry.php/panel/sysgroup/sub/create/s/save">
    <tr>
        <td align="right" class="thc" width="200">System Group Name:</td>
        <td class="tdc">&nbsp;<input type="text" name="sysgroup_name" size="90"><font color="blue"> *</font></td>
    </tr>
    <tr>
        <td align="right" class="thc">System Group Nickname:</td>
        <td class="tdc">&nbsp;<input type="text" name="sysgroup_nickname" size="90"><font color="blue"> *</font></td>
    </tr>
</table>
<br>
<br>
