...
?>
                ...
                <tr>
                    ...
                    <td width="100%"><b>Description:</b> <br>
                        <table width="770"  class="tbframe" bgcolor="#eeeeee">
                            <tr><td><?php echo $this->finding['finding_data'];?>&nbsp;</td></tr>
                        </table>
                    </td>
                    <td></td>
                </tr>
    ...
    <tr>
        <td>
            ...
            <table class="tipframe">
                <tr><th align="left" colspan="3">Vulnerability:</td></tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table border="0" width="637" cellpadding="3" cellspacing="1" class="tbframe" bgcolor="#eeeeee">
                                                <tr>
                                                    <td>
                                                        <?php echo $vobj['vuln_desc_primary'];
                                    ...
                                    <tr><td>
                                        ...
                                        <legend><b>The vulnerability will cost the loss of</b></legend>
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                <tr><td><input type="checkbox" name="vuln" value="1" onclick="return false;"
                                                    <?php 
