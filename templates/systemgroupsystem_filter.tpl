...
<table border='0'>
  ...
  <tr>
    ...
    <td>sysgroup id</td>
	<td>{html_options name='sysgroup_id_bool' values=$bool_values  output=$bool_options selected=$sysgroup_id_bool }</td>
	<td>{html_options name='sysgroup_id'      values=$sysgroup_ids output=$sysgroup_ids selected=$sysgroup_id }</td>
  ...
  <tr>
    ...
    <td>system id</td>
	<td>{html_options name='system_id_bool' values=$bool_values  output=$bool_options selected=$system_id_bool }</td>
	<td>{html_options name='system_id'      values=$system_ids output=$system_ids selected=$system_id }</td>
