...
<table border='0' cellpadding='2' cellspacing='0'>
	...
	<tr>
		...
		<th align='left'>VulnType
			<input type='image' src='images/button_up.png'   name='sort_params' value='vuln_type ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='vuln_type DESC'>
		</th>

		<th align='left'>VulnDescPrimary
			<input type='image' src='images/button_up.png'   name='sort_params' value='vuln_desc_primary ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='vuln_desc_primary DESC'>
		</th>

		<th align='left'>VulnDescSecondary
			<input type='image' src='images/button_up.png'   name='sort_params' value='vuln_desc_secondary ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='vuln_desc_secondary DESC'>
		</th>
	...
	{* loop through the vuln list and populate with values *}
	{section name=vuln loop=$vuln_list}

	<tr bgcolor='{cycle values="#EEEEEE,#CCCCCC"}' >


		<td> {$vuln_list[vuln].vuln_type} </td>
		<td> {$vuln_list[vuln].vuln_desc_primary} </td>
		<td> {$vuln_list[vuln].vuln_desc_secondary} </td>

		<form name='system_view' method='post' action='{$this_page}'>
		<td>
            <input type='hidden' name='form_target' value='vuln'>
			<input type='hidden' name='referrer'    value='{$this_page}'>
			<input type='hidden' name='vuln_seq'   value='{$vuln_list[vuln].vuln_seq}'>
