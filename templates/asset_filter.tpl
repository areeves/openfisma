...
<table border='0'>
  ...
  <tr>
    ...
    <td>asset name</td>
	<td>{html_options name='asset_name_bool' values=$bool_values  output=$bool_options selected=$selected_name_bool }</td>
	<td>{html_options name='asset_name'      values=$unique_names output=$unique_names selected=$selected_name }</td>
  ...
  <tr>
    ...
    <td>asset date created</td>
	<td>{html_options name='asset_date_created_bool' values=$bool_values  output=$bool_options selected=$selected_date_created_bool }</td>
	<td>{html_options name='asset_date_created'      values=$unique_date_createds output=$unique_date_createds selected=$selected_date_created }</td>
  ...
  <tr>
    ...
    <td>asset source</td>
	<td>{html_options name='asset_source_bool' values=$bool_values  output=$bool_options selected=$selected_source_bool }</td>
	<td>{html_options name='asset_source'      values=$unique_sources output=$unique_sources selected=$selected_source }</td>
