...
<table border='0' cellpadding='2' cellspacing='0'>
	...
	<tr>
		...
		<th align='left'>ProdName
			<input type='image' src='images/button_up.png'   name='sort_params' value='prod_name ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='prod_name DESC'>
		</th>

		<th align='left'>ProdVersion
			<input type='image' src='images/button_up.png'   name='sort_params' value='prod_version ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='prod_version DESC'>
		</th>

		<th align='left'>ProdDesc
			<input type='image' src='images/button_up.png'   name='sort_params' value='prod_desc ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='prod_desc DESC'>
		</th>
	...
	{* loop through the product list and populate with values *}
	{section name=product loop=$product_list}

	<tr bgcolor='{cycle values="#EEEEEE,#CCCCCC"}' >


		<td> {$product_list[product].prod_name} </td>
		<td> {$product_list[product].prod_version} </td>
		<td> {$product_list[product].prod_desc} </td>

		<form name='system_view' method='post' action='{$this_page}'>
		<td>
            <input type='hidden' name='form_target' value='product'>
			<input type='hidden' name='referrer'    value='{$this_page}'>
			<input type='hidden' name='prod_id'   value='{$product_list[product].prod_id}'>
