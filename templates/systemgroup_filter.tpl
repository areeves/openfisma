...
<table border='0'>
  ...
  <tr>
    ...
    <td>sysgroup name</td>
	<td>{html_options name='sysgroup_name_bool' values=$bool_values  output=$bool_options selected=$sysgroup_name_bool }</td>
	<td>{html_options name='sysgroup_name'      values=$sysgroup_names output=$sysgroup_names selected=$sysgroup_name }</td>
  ...
  <tr>
    ...
    <td>sysgroup nickname</td>
	<td>{html_options name='sysgroup_nickname_bool' values=$bool_values  output=$bool_options selected=$sysgroup_nickname_bool }</td>
	<td>{html_options name='sysgroup_nickname'      values=$sysgroup_nicknames output=$sysgroup_nicknames selected=$sysgroup_nickname }</td>
  ...
  <tr>
    ...
    <td>sysgroup is identity</td>
	<td>{html_options name='sysgroup_is_identity_bool' values=$bool_values  output=$bool_options selected=$sysgroup_is_identity_bool }</td>
	<td>{html_options name='sysgroup_is_identity'      values=$siesgroup_is_identities output=$siesgroup_is_identities selected=$sysgroup_is_identity }</td>
