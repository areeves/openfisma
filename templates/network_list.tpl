...
<table border='0' cellpadding='2' cellspacing='0'>
	...
	<tr>
		...
		<th align='left'>NetworkName
			<input type='image' src='images/button_up.png'   name='sort_params' value='network_name ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='network_name DESC'>
		</th>

		<th align='left'>NetworkNickname
			<input type='image' src='images/button_up.png'   name='sort_params' value='network_nickname ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='network_nickname DESC'>
		</th>

		<th align='left'>NetworkDesc
			<input type='image' src='images/button_up.png'   name='sort_params' value='network_desc ASC'>
			<input type='image' src='images/button_down.png' name='sort_params' value='network_desc DESC'>
		</th>
	...
	{* loop through the network list and populate with values *}
	{section name=network loop=$network_list}

	<tr bgcolor='{cycle values="#EEEEEE,#CCCCCC"}' >


		<td> {$network_list[network].network_name} </td>
		<td> {$network_list[network].network_nickname} </td>
		<td> {$network_list[network].network_desc} </td>

		<form name='system_view' method='post' action='{$this_page}'>
		<td>
            <input type='hidden' name='form_target' value='network'>
			<input type='hidden' name='referrer'    value='{$this_page}'>
			<input type='hidden' name='network_id'   value='{$network_list[network].network_id}'>
