...
<table border='0'>
  ...
  <tr>
    ...
    <td>asset id</td>
	<td>{html_options name='asset_id_bool' values=$bool_values  output=$bool_options selected=$asset_id_bool }</td>
	<td>{html_options name='asset_id'      values=$asset_ids output=$asset_ids selected=$asset_id }</td>
