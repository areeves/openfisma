...
<table border='0'>
  ...
  <tr>
    ...
    <td>network name</td>
	<td>{html_options name='network_name_bool' values=$bool_values  output=$bool_options selected=$selected_name_bool }</td>
	<td>{html_options name='network_name'      values=$unique_names output=$unique_names selected=$selected_name }</td>
  ...
  <tr>
	...
	<td>{html_options name='network_nickname_bool' values=$bool_values  output=$bool_options selected=$selected_nickname_bool }</td>
	<td>{html_options name='network_nickname'      values=$unique_nicknames output=$unique_nicknames selected=$selected_nickname }</td>
  ...
  <tr>
    ...
    <td>network desc</td>
	<td>{html_options name='network_desc_bool' values=$bool_values  output=$bool_options selected=$selected_desc_bool }</td>
	<td>{html_options name='network_desc'      values=$unique_descs output=$unique_descs selected=$selected_desc }</td>
