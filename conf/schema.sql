...
CREATE TABLE FINDINGS (
  ...
  finding_date_discovered date NOT NULL default '0000-00-00',
...
CREATE TABLE FINDING_SOURCES (
  ...
  source_nickname varchar(8) NOT NULL default '',
  source_desc text,
...
CREATE TABLE ROLES (
  ...
  role_nickname varchar(8) default NULL,
...
CREATE TABLE SYSTEMS (
  ...
  system_desc text,
  system_type enum('GENERAL SUPPORT SYSTEM','MAJOR APPLICATION') NOT NULL default 'GENERAL SUPPORT SYSTEM',
...
CREATE TABLE USERS (
  ...
  user_old_password1 varchar(64) default NULL,
  user_old_password2 varchar(64) default NULL,
  user_old_password3 varchar(64) default NULL,
  ...
  user_phone_office varchar(13) NOT NULL default '',
  user_phone_mobile varchar(13) default NULL,
...
--
-- Table structure for table 'VULNERABILITIES_02102006'
--

CREATE TABLE VULNERABILITIES_02102006 (
  vuln_seq int(10) unsigned NOT NULL auto_increment,
  vuln_type char(3) NOT NULL default '',
  vuln_desc_primary text NOT NULL,
  vuln_desc_secondary text,
