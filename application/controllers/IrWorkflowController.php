...
class IRWorkflowController extends SecurityController
{
    ...
    public function searchbox()
    {
        ...
        $this->view->createIrWorkflowDefPrivilege = Fisma_Acl::hasPrivilegeForClass('create', 'IrWorkflowDef');
    ...
    public function viewAction()
    {
        ...
        $this->view->updateIrWorkflowDefPrivilege = Fisma_Acl::hasPrivilegeForClass('update', 'IrWorkflowDef');
        $this->view->deleteIrWorkflowDefPrivilege = Fisma_Acl::hasPrivilegeForClass('delete', 'IrWorkflowDef');
        $this->render($v);
    }
