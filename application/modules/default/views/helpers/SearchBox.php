...
class View_Helper_SearchBox extends Zend_View_Helper_Abstract
{
     ...
     * @param array $searchButtons Array of Fisma_Yui_Form_Button for return, next, and previous
     * @param bool $searchFormLeft If set to true, the searchform will be on the left
     * @return string
     */
    public function searchBox($toolbarButtons, $searchForm = null, $searchButtons = null, $searchFormLeft = false)
    {
