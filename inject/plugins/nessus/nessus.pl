...
# ---------------------------------------------------------------------------
# FILE     : nessus.pl
# DESC     : Plugin to translate Nessus scan XML-format reports
...
# ---------------------------------------------------------------------------
	...
	#
        ...
        my ($std_string_arr_ref, $err_str_arr_ref) = nessus_translation::translate($raw_data_string);
...
$inject_utils::this_name = "nessus"; # TODO: put plugin name here (lowercase, no spaces)
